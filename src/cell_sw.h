...
const uint32_t *get_door_cell(uint32_t door_id) {
  ...
  case 0x0001BD36: case 0x0001BD41: case 0x0001D5FC:
  case 0x0001D5FD: case 0x0001D5FE: case 0x0001D5FF:
  case 0x00017411: case 0x00017A17: case 0x00019B4E:
  case 0x0001DA16: case 0x0001E352: case 0x0001E984:
  case 0x0001E987: case 0x00023609: case 0x0002363E:
  case 0x0002360A: case 0x00025420: case 0x0002ABBA:
  case 0x0002ABB9: case 0x0002ABB8: case 0x0002ABBB:
  case 0x00028528: case 0x00028529: case 0x0002B0F8:
  case 0x0002B0FC: case 0x0002B0FD: case 0x0002B0FE:
  case 0x0002B8D1: case 0x0002DCD9: case 0x0002DB45:
  case 0x0002DCDD: case 0x0002DCDE: case 0x0002DCE0:
  case 0x0002DED7: case 0x0002DED8: case 0x0002E03C:
  case 0x0002E0E4: case 0x0002E5E4: case 0x0002FCC7:
  case 0x00030602: case 0x0003C840: case 0x0003C841:
  case 0x0003C847: case 0x0003C948: case 0x0003C949:
  case 0x0003BD8C: case 0x0003C2FA: case 0x0003D447:
  case 0x000433AC: case 0x00043B8A: case 0x00044B12:
  case 0x00044B14: case 0x00044D09: case 0x00048190:
  case 0x00048191: case 0x00048192: case 0x00048306:
  case 0x0004CCE9: case 0x0004CCEA: case 0x0004D030:
  case 0x0004D031: case 0x0004E73A: case 0x0004F135:
  case 0x0004F656: case 0x00050F55: case 0x00051466:
  case 0x00051467: case 0x0005364D: case 0x000560EC:
  case 0x000560F4: case 0x0004021A: case 0x00042F27:
  case 0x0004E1C4: case 0x00057E2A: case 0x00058BFB:
  case 0x0003F535: case 0x0003F538: case 0x0005AAB5:
  case 0x0005AB78: case 0x0005D863: case 0x00063B37:
  case 0x00063B72: case 0x000687CD: case 0x00068C88:
  case 0x0006A17B: case 0x0006C247: case 0x0007012B:
  case 0x000752C9: case 0x000752CA: case 0x00079F14:
  case 0x00089C77: case 0x0006F6A6: case 0x00093706:
  case 0x00098744: case 0x0003DFC6: case 0x0009C4CB:
  case 0x0009DF52: case 0x0009DF53: case 0x000A5E88:
  case 0x000A6F41: case 0x0005DD39: case 0x000B36E4:
  case 0x000B5F0B: case 0x000B754F: case 0x000B7550:
  case 0x000B754E: case 0x00018E56: case 0x000190F2:
  case 0x000B548B: case 0x0001FC8F: case 0x00023603:
  case 0x000B9E64: case 0x00024ECA: case 0x0002A344:
  case 0x00017281: case 0x0002DF06: case 0x00039272:
  case 0x00039391: case 0x000392A7: case 0x0003E897:
  case 0x0003EE0D: case 0x00061520: case 0x00061BB7:
  case 0x00064C00: case 0x00070C6C: case 0x00076E43:
  case 0x00076E46: case 0x00076E49: case 0x000A3422:
  case 0x000C25A7: case 0x000C25EA: case 0x000C2677:
  case 0x000C2727: case 0x000C27B0: case 0x000C27BB:
  case 0x000C30AF: case 0x000C3C1C: case 0x000C84C5:
  case 0x0005608F: case 0x000494D2: case 0x00049C94:
  case 0x000CA776: case 0x000CA9F7: case 0x0009CA2A:
  case 0x0009DBB2: case 0x000A4291: case 0x00044C5E:
  case 0x0004E6F3: case 0x0004E776: case 0x0005281B:
  ...
  case 0x0007DD37: case 0x000310CC: case 0x000173EF:
  ...
  case 0x000181D4: case 0x000181D8:
  return cell_00017F4F;
  ...
  case 0x00018130: case 0x00054830:
  return cell_00017F5A;
  ...
  case 0x00035363: case 0x000185FA: case 0x000185FB:
  ...
  case 0x0004DB47: case 0x0004DB4A: case 0x0004DB49:
  case 0x0004DB4B: case 0x0006D994: case 0x0007C608:
  ...
  case 0x0004CFA3: case 0x0004CD80: case 0x0004CDAA:
  case 0x0004CD24: case 0x0002D247:
  ...
  case 0x00027DE6: case 0x0004BC2F: case 0x0004BC30:
  case 0x0004BC40: case 0x000606B7: case 0x0006937A:
  case 0x00041562: case 0x000A4B13: case 0x000AE889:
  case 0x0001B5B5: case 0x0001B5B6:
  ...
  case 0xFF00C0BA: case 0xFF00CA58: case 0xFF00D202:
  case 0xFF00D6B1: case 0xFF00DA2E: case 0xFF00DDD6:
  case 0xFF00DF5A: case 0xFF00DDFB: case 0xFF00E27E:
  case 0xFF00B2D2: case 0xFF00BFF8: case 0xFF00C04A:
  case 0xFF00CDD8: case 0xFF00CDDB: case 0xFF00CDE8:
  case 0xFF00A55B: case 0xFF00B14E: case 0xFF00F030:
  case 0xFF00A546: case 0xFF00A54A: case 0xFF011FA2:
  case 0xFF00583B: case 0xFF00643D: case 0xFF006B69:
  case 0xFF007AFA: case 0xFF00AE73: case 0xFF00B86B:
